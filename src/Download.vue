...
<template>
    ...
    <div class="flex justify-center items-center text-center">
      <div class="p-2">
        ...
        <a
          ...
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/tag/3.4.0"
  ...
  <div v-if="showDropdown" class="dropdown-menu z-100">
    <div v-if="isWindows">
      ...
      >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes.Setup.3.4.0.exe"
          class="block px-4 py-2 hover:bg-grey-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
          >Intel (64-bit)</a
        >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes.Setup.3.4.0.arm64.exe"
          class="block px-4 py-2 hover:bg-grey-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
          >Arm (64-bit)</a
        >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes.3.4.0.exe"
          class="block px-4 py-2 hover:bg-grey-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
          >Portable Intel (64-bit)</a
        >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes.3.4.0.arm64.exe"
          class="block px-4 py-2 hover:bg-grey-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
        >
          Arm (64-bit)</a
    ...
    <div v-else-if="isLinux">
      ...
      >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes-3.4.0.AppImage"
          class="block px-4 py-2 hover:bg-gray-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
          >Appimage x64</a
        >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes-3.4.0-arm64.AppImage"
          class="block px-4 py-2 hover:bg-gray-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
          >Appimage Arm (64-bit)</a
        >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes_3.4.0_amd64.deb"
          class="block px-4 py-2 hover:bg-gray-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
          >Deb x64</a
        >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes_3.4.0_arm64.deb"
          class="block px-4 py-2 hover:bg-gray-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
          >Deb Arm (64-bit)</a
        >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes-3.4.0.x86_64.rpm"
          class="block px-4 py-2 hover:bg-gray-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
          >Rpm x64</a
        >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes-3.4.0.aarch64.rpm"
          class="block px-4 py-2 hover:bg-gray-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
          >Rpm Arm (64-bit)</a
        >
    ...
    <div v-else-if="isMac">
      ...
      >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes.dmg"
          class="block px-4 py-2 hover:bg-grey-100 text-black hover:text-black"
          style="font-family: 'Arimo', sans-serif"
          >Intel processor</a
        >
        <a
          href="https://github.com/Beaver-Notes/Beaver-Notes/releases/download/3.4.0/Beaver-notes-arm64.dmg"
  ...
  <div class="py-10 sm:py-16 md:py-24">
    <div
      class="p-2 hidden lg:block md:block shadow-sm border-2 rounded-xl w-2/5 mx-auto"
    >
      <p class="text-2xl font-bold text-left text-neutral-800 px-2 py-2">
        Other Platforms
      </p>
      ...
      <div class="border-b-2 flex items-center justify-between">
        <p class="px-2 text-xl font-bold text-left text-gray-800 py-2">
          Windows
        </p>
        <div class="py-2 flex flex-col items-start pr-[0.8em]">
          ...
          <a
            ...
            style="font-family: 'Arimo', sans-serif"
          >
            <ArrowDownTrayIcon class="w-8 h-8 mr-2" /> Portable Arm (64-bit)
          </a>
        </div>
      </div>
